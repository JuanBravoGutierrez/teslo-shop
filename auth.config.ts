...
export default {
  ...
  secret: process.env.AUTH_SECRET, // asegúrate de tener AUTH_SECRET en .env
  // Puedes incluir callbacks, events, pages, etc. aquí si lo deseas
